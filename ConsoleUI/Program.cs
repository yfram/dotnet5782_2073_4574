...
namespace ConsoleUI
{
    class Program
    {
        ...
        {
            DalApi d = new DalObject.DalObject();
        ...
        private static void GetListMenu(DalApi d)
        {
        ...
        private static void GetByIdMenu(DalApi d)
        {
        ...
        private static void UpdateMenu(DalApi d)
        {
        ...
        private static void AddMenu(DalApi d)
        {
